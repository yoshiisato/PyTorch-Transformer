...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model: int, seq_len: int, dropout: float) -> None:
        ...
        position = torch.arange(0, seq_len, dtype=torch.float).unsequeeze(1) # (seq_len, 1)
...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def attention(query, key, value, mask, dropout: nn.Dropout):
        ...
        return (attention_scores @ value), attention_scores # The attention score is printed for visaulization
    ...
    def forward(self, q, k, v, mask):
        ...
        # (Batch, h, Seq_len, d_k) --> (Batch, seqlen, h, d_k) --> (batch, seqlen, d_model)
...
class Transformer(nn.Module):
    ...
    def encode(self, src, src_mask):# to reuse the output of the encoder
